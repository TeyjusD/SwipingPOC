...
public class CloudRecoEventHandler : MonoBehaviour
{
    ...
    [FormerlySerializedAs("m_ImageTargetBehaviour")] public ImageTargetBehaviour ImageTargetBehaviour;
    [FormerlySerializedAs("m_CloudActivityIcon")] public UnityEngine.UI.Image CloudActivityIcon;
    [FormerlySerializedAs("m_CloudIdleIcon")] public UnityEngine.UI.Image CloudIdleIcon;
    ...
    /// </summary>
    public void OnInitialized(ObjectRecoBehaviour objectRecoBehaviour)
    {
    }
